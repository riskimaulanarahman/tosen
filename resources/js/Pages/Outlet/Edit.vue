...
const form = useForm({
    ...
    default_salary: props.outlet.default_salary || "",
    use_tax: props.outlet.use_tax ?? true,
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                />
                                <div
                                    v-if="form.errors.default_salary"
                                    class="mt-1 text-sm text-error"
                                >
                                    {{ form.errors.default_salary }}
                                </div>
                                <p class="text-xs text-muted mt-1">
                                    Dipakai jika karyawan tidak memiliki base
                                    salary.
                                </p>
                            </div>
                            <div class="flex items-end">
                                <label class="inline-flex items-center">
                                    ...
                                    <span class="text-sm text-text"
                                        >Terapkan pajak 5% pada payroll</span
                                    >
                                </label>
                            </div>
                        </div>
